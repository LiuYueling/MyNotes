...
<a href="#Git 基本用法">Git 基本用法</a> <br>
|-- <a href="#1. 创建 git 仓库">1. 创建 git 仓库</a> <br>
|-- <a href="#2. 把文件添加到版本库中">2. 把文件添加到版本库中</a> <br>
|-- <a href="#3. 提交修改">3. 提交修改</a> <br>
|-- <a href="#4. 版本回退">4. 版本回退</a> <br>
|-- <a href="#5. Git 工作区和暂存区">5. Git 工作区和暂存区</a> <br>
|-- <a href="#6. 撤销修改和删除文件">6. 撤销修改和删除文件</a> <br>
|&nbsp;&nbsp;|-- <a href="#6.1. 撤销修改">6.1. 撤销修改</a> <br>
|&nbsp;&nbsp;\`-- <a href="#6.2. 删除文件">6.2. 删除文件</a> <br>
|-- <a href="#7. 远程仓库">7. 远程仓库</a> <br>
|&nbsp;&nbsp;|-- <a href="#7.1. 生成密钥">7.1. 生成密钥</a> <br>
|&nbsp;&nbsp;|-- <a href="#7.2. GitHub 添加密钥">7.2. GitHub 添加密钥</a> <br>
|&nbsp;&nbsp;\`-- <a href="#7.3. GitHub 测试">7.3. GitHub 测试</a> <br>
|-- <a href="#8. 创建与合并分支">8. 创建与合并分支</a> <br>
|-- <a href="#9. 现场保存与恢复现场">9. 现场保存与恢复现场</a> <br>


## Git 基本用法

<a href="#Git 使用教程">返回目录</a> <br>
